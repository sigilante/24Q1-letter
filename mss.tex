...
Many have contributed, not least the authors of the code and articles.  I would particularly like to thank \patp{mopfel-winrux} for his early enthusiasm for the concept of \textsc{ustj}; \patp{wolref-podlex} for paving the way; each contributor, reviewer, and designer; and Simon DeDeo, who first suggested to us the idea of a technical journal.
